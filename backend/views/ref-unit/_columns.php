...
return [
    ...
    [
        'class'=>'\kartik\grid\DataColumn',
        'label'=> $div .  'Cepat Kode' . $icon . '</div>',
        'attribute'=>'cepat_kode',
        'vAlign' => 'middle',
        'encodeLabel' => false,
    ],
        ...
        'buttons' => [
            ...
            "delete" => function ($url, $model, $key) {
                return Html::a('<i class="fas fa-trash" width="16" height="16" class="me-1 align-middle"></i>', ['delete', 'id' => $model->id], [
                    ...
                    'data-toggle' => 'tooltip',
                    'data-confirm-title' => 'Hapus Ref Unit',
                    'data-confirm-ok' => 'Yakin',
                    'data-confirm-cancel' => 'Kembali',
                    'data-confirm-message' => 'Apakah kamu yakin ingin menghapus Ref Unit ini?'
                ]);
            },

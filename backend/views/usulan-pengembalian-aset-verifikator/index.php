...
/* @var $searchModel backend\models\UsulPengembalianAsetVerifikatorSearch */
...
<div class="pengembalian-barang-index">
    <?= GridView::widget(
        [
            'id' => 'crud-datatable',
            ...
            'panel' => [
                ...
                'heading' => '<div class="d-flex justify-content-between align-items-center">
                                    <h5 class="m-0 text-dark title-index" style="text-transform:uppercase">Pengembalian Barang</h5>
                                </div>',
                'before' => false,
                'after' => false,
            ],

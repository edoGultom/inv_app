        ...
        [
            ...
            'panel' => [
                ...
                'heading' => '<div class="d-flex justify-content-between align-items-center">
                                    <h5 class="m-0 text-dark title-index" style="text-transform:uppercase">User</h5>' .
                    Html::a(
                        '<div class="d-flex align-items-center"><i class="fas fa-circle-plus" class="me-5"></i> <span class="align-middle"> Tambah User</span></div>',
                        ['create'],
                        ['role' => 'modal-remote', 'title' => 'Tambah User', 'class' => 'btn btn-danger btn-sm']
                    ) .
                    '</div>',
                'before' => false,
                'after' => false,

...
/* @var $searchModel backend\models\RefSatuanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = "Ref Satuan";
            ...
            [
                ...
                'panel' => [
                    ...
                    'heading' => '<div class="d-flex justify-content-between align-items-center">
                                    <h5 class="m-0 text-dark title-index" style="text-transform:uppercase">Ref Satuan</h5>' .
                                    Html::a(
                                        '<div class="d-flex align-items-center"><i class="fas fa-solid fa-square-plus  me-1"></i> Tambah Ref Satuan</div>',
                                        ['create'],
                                        ['role' => 'modal-remote', 'title' => 'Tambah Ref Satuan', 'class' => 'btn btn-danger btn-sm']
                                    ) . 
                                 '</div>',
                    'before' => false,
                    'after' => false,

...
<?php if (!empty($generator->searchModelClass)) : ?>
    ...
    if($request->isAjax){
        ...
        return [
            ...
            Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-light pull-left', 'data-bs-dismiss' => "modal"])
        ];
    } else {
...
public function actionView(<?= $actionParams ?>)
{
    ...
    if($request->isAjax){
        ...
        return [
            ...
            'footer'=> Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class'=>'btn btn-light pull-left','data-bs-dismiss'=>"modal"]).
